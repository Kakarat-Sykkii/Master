...
<h2>Liikunta on tärkeää kaikille</h2>
        <span class="byline">Tässä hieman lisää liikunnasta</span> 
    <p>Liikunnasta jotain selitetty tähän iha vitusti mmäääääääään</p>
    </div>
    ...
    <div id="portfolio" class="wrapper-style1">
        ...
        <div id="column1">
            ...
            <a href="#" class="button">Haluatko tietää lisää?</a> </div>
        <div id="column2">
            <p><a href="#" class="image image-full"><img src="images/Aatu 10 v.jpeg" alt="" /></a></p>
